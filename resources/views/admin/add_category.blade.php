                ...
                <form class="form-horizontal" action="{{url('/save-category')}}" method="post">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" id="category_description" name="category_description" rows="3" required></textarea>
                            </div>
                        </div>
                        {{--<div class="control-group hidden-phone">--}}
                            {{--<label class="control-label" for="textarea2">Publication status</label>--}}
                            {{--<div class="controls">--}}
                                {{--<textarea class="cleditor" name="publication _status" rows="3"></textarea>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                        <div class="control-group hidden-phone">
                            <label class="control-label" for="publication_status">Publication status</label>
                            <div class="controls">
                                <input type="checkbox" id="publication_status" name="publication_status" rows="3" value="1">
                            </div>
                        </div>
